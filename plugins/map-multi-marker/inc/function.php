...
function mapmarker_plugin_activation(){
    ...
    if(empty($check_option)){
        ...
        $wpdb->insert($table_option,
            array(
                ...
                'fiels_to_display'       => 'image,titre,location,description,adresse,telephone,weblink',
    ...
    description VARCHAR(1600) DEFAULT '' NOT NULL,
...
function mapmarkerMarkerContent(){
    ...
    if(mapmarker_get_checked_field($option[ 0 ][ 'fiels_to_display' ], 'titre') == TRUE OR mapmarker_get_checked_field($option[ 0 ][ 'fiels_to_display' ], 'description') OR mapmarker_get_checked_field($option[ 0 ][ 'fiels_to_display' ], 'location') == TRUE OR mapmarker_get_checked_field($option[ 0 ][ 'fiels_to_display' ], 'adresse') == TRUE OR mapmarker_get_checked_field($option[ 0 ][ 'fiels_to_display' ], 'telephone') == TRUE OR mapmarker_get_checked_field($option[ 0 ][ 'fiels_to_display' ], 'weblink') == TRUE){
        ?>
...
function mapMarkerCreateMarker(){
    ...
    $wpdb->insert($table_name,
        array(
            ...
            'description'     => stripslashes($_POST[ 'add_description' ]),
            'location'     => stripslashes($_POST[ 'add_location' ]),
