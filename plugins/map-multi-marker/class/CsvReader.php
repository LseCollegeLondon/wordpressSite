...
class CsvReader {
    ...
    static function insertCsv($file, $mapId, $imgId){
        ...
        $placeholder = "INSERT INTO $table(marker_id,titre,description,location,adresse,telephone,weblink,img_desc_marker,img_icon_marker,latitude,longitude) VALUE( %d, %s, %s, %s, %s, %s, %d, %d, %s, %s )";
        $line = 1;
