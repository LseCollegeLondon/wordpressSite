            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <table class="widefat" id="table_markers">
                    ...
                    <tr>
                        ...
                        ?>
                        <?php
                        if(mapmarker_get_checked_field($options[ 0 ][ 'fiels_to_display' ], 'location') == TRUE){
                            ?>
                            <th><strong><?php _e('Location', 'map-multi-marker') ?></strong></th>
                            <?php
                        }
                        ?>
                        <?php
                    ...
                    foreach($data as $item){
                        ...
                        <tr>
                            ...
                            if(mapmarker_get_checked_field($options[ 0 ][ 'fiels_to_display' ], 'location') == TRUE){
                                ?>
                                <td>
                                    <textarea maxlength="255" name="location" disabled><?php echo html_entity_decode(esc_textarea($item[ 'location' ])) ?></textarea>
                                </td>
                                <?php
                            }
                            ?>
                            ...
                            if(mapmarker_get_checked_field($options[ 0 ][ 'fiels_to_display' ], 'description') == TRUE){
                                ?>
                                <td>
                                    <textarea name="description" disabled><?php echo html_entity_decode(esc_textarea($item[ 'description' ])) ?></textarea>
                                </td>
                                <?php
                            }
                            ?>
                    ...
                    <tr>
                        ...
                        if(mapmarker_get_checked_field($options[ 0 ][ 'fiels_to_display' ], 'location') == TRUE){
                            ?>
                            <td>
                                <textarea maxlength="255" style="width:100%" id="add_location" name="add_location" placeholder="<?php echo _e('Location') ?>"></textarea>
                            </td>
                            <?php
                        }
                        ?>
                        ...
                        if(mapmarker_get_checked_field($options[ 0 ][ 'fiels_to_display' ], 'description') == TRUE){
                            ?>
                            <td>
                                <textarea  style="width:100%" id="add_description" name="add_description" placeholder="<?php echo _e('Description') ?>"></textarea>
                            </td>
                            <?php
                        }
                        ?>
